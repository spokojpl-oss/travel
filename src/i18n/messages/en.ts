...
export const en: Messages = {
  ...
  rhythm: {
    ...
    presetCyclingBeachMix: "Beach + cycling",
    presetCyclingBeachMixDesc: "Beach days interleaved with bike routes",
    presetCyclingBeachMixDescLake: "Lake days interleaved with bike routes",
    presetCyclingOnly: "Cycling only",
    presetCyclingOnlyDesc: "The whole trip focused on riding — routes, rentals, MTB",
    customTitle: "Day allocation",
    customHint: "Total must equal trip length.",
    themeBeach: "Beach time",
    themeBeachDesc: "Relax by the sea",
    themeBeachDescLake: "Relax by the lake or water",

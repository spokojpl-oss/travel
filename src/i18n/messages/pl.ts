export const pl = {
  ...
  search: {
    ...
    subtitleOverview:
      "Sprawdzamy pogodę i szukamy atrakcji w okolicy — dostaniesz gotowe propozycje.",
    discoverLabel: "Analizujemy destynację",
    discoverCoords: "Ustalamy lokalizację…",
    discoverPhaseWeather: "Sprawdzamy pogodę na Wasze daty…",
    discoverPhasePlaces: "Szukamy atrakcji i miejsc w okolicy…",
    discoverPhaseMatch: "Dopasowujemy propozycje do wyjazdu…",
